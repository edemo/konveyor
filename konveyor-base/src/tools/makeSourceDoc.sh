...
java -cp $(target/tools/mkClassPath.sh) io.github.magwas.tooling.Main . >target/AST.xml
target/tools/makeSourceDocbook.sh . > target/generated-site/resources/apidoc.docbook
